...
//You have been asked to review Provider and ProviderInterface written by one of your team member. Improve this code as you see fit.
//You may assume that:
//	- ProviderInterface is located in a separate file
//	- Injected objects and the methods called on those are available to you and they are already reviewed/approved.
...
interface ProviderInterface{
	...
	boolean scheduleAppointmentForPaitientByEmail(DateTime appointmentTime, Long paitientID);
